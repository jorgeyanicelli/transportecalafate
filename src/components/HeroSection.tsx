    ...
    <div className="hero-pattern py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-calafate-950">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button 
              size="lg" 
              className="bg-calafate-600 hover:bg-calafate-700 text-white px-8"
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-calafate-600 text-calafate-600 hover:bg-calafate-50"
            >
              Conocer Más
            </Button>
          </div>
